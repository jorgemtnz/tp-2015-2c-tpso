...
src/%.o: ../src/%.c
	...
	gcc -I"/home/utnso/tp-2015-2c-tpsobranch/utiles" -I"/home/utnso/tp-2015-2c-tpsobranch/commons-library" -O0 -g3 -Wall -c -fmessage-length=0 -pthread -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
